...
export default function ChatSupport() {
  ...
  return (
    <div className="relative">
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed lg:bottom-34 lg:right-20 bottom-21 right-4 flex flex-col lg:w-[525px] h-[480px] w-[400px] bg-ink-light border border-border rounded-[20px] shadow-[0_40px_80px_rgba(0,0,0,0.5),0_0_0_1px_var(--border)] overflow-hidden">
          {/* Header */}
