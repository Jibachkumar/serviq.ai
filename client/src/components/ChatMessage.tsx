...
export default function ChatSupport() {
  ...
  return (
    <div className="relative">
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className=" fixed bottom-[84px] right-[16px] lg:bottom-[137px] lg:right-[80px] w-[min(90vw,430px)] lg:w-[525px] h-[480px] right-4 flex flex-col bg-ink-light border border-border rounded-[20px] shadow-[0_40px_80px_rgba(0,0,0,0.5),0_0_0_1px_var(--border)] overflow-hidden">
          {/* Header */}
